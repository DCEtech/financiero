...
```
* Se generará un código QR en la consola, lo escaneamos con la cámara del movil, esto generará una url que sera procesada por la aplicación y flet y nos mostrará la app.
